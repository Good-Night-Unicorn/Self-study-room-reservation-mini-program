<template>
	<view :style='{"minHeight":"100vh","padding":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		...
		<view :style='{"padding":"20rpx","margin":"0px auto","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","order":"4"}'>
		  <view :style='{"padding":"16rpx 50rpx","borderRadius":"40rpx","background":"#d3e5ff","display":"flex"}' @click="likeClick">
		  ...
		  <view :style='{"padding":"16rpx 50rpx","borderRadius":"40rpx","background":"#d3e5ff","display":"flex"}' @click="collectClick">
		...
		<div :style='{"padding":"20rpx 24rpx 40rpx","margin":"0px auto","borderRadius":"0px","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto","order":"6"}'>
		  <div @click="prepDetailClick" :style='{"padding":"0 20rpx","margin":"0 40rpx 0 0","color":"#666","borderRadius":"20rpx","textAlign":"center","background":"#d3e5ff","width":"auto","lineHeight":"72rpx","fontSize":"28rpx"}'>上一篇：prev</div>
		  <div @click="nextDetailClick" :style='{"padding":"0 20rpx","color":"#fff","borderRadius":"20rpx","textAlign":"center","background":"#174add","width":"auto","lineHeight":"72rpx","fontSize":"28rpx"}'>下一篇：next</div>
		</div>
		

		<!-- 热门 -->
		<view class="hot" :style='{"width":"calc(100% - 48rpx)","margin":"40rpx auto 0","background":"none","height":"auto","order":"10"}'>
		  <view :style='{"padding":"0 0 0 0px","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#000","textAlign":"left","background":"none","borderWidth":"0 0 0 0px","width":"100%","fontSize":"44rpx","position":"relative","borderStyle":"solid","fontWeight":"600"}'>热门信息</view>
		  <view :style='{"padding":"0","borderRadius":"20rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in hotList" :key="index" :style='{"border":"2rpx solid #174add60","padding":"20rpx","margin":"0 0 40rpx","borderRadius":"20rpx","background":"linear-gradient(180deg, rgba(33,83,223,1) 0%, rgba(255,255,255,1)50%, rgba(255,255,255,1) 100%)","width":"48%","height":"auto"}' @click="toDetail(item.id)">
			  <image :style='{"width":"100%","margin":"0","objectFit":"cover","borderRadius":"12rpx","display":"block","height":"200rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
		...
		<view class="recommend" :style='{"width":"calc(100% - 48rpx)","margin":"0px auto 0","background":"none","height":"auto","order":"12"}'>
		  <view :style='{"padding":"0 0 0 0px","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#000","textAlign":"left","background":"","borderWidth":"0 0 0 0px","width":"100%","fontSize":"44rpx","position":"relative","borderStyle":"solid","fontWeight":"600"}'>最新推荐</view>
		  <view :style='{"padding":"0","borderRadius":"20rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in recommendList" :key="index" :style='{"border":"2rpx solid #174add","padding":"12rpx","margin":"0 0 40rpx","borderRadius":"20rpx","background":"#f0f8ff","width":"48%","height":"auto"}' @click="toDetail(item.id)">
		      <image :style='{"margin":"0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"130rpx","float":"left","height":"180rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
			  <view :style='{"padding":"0 8rpx","overflow":"hidden","color":"#333","maxHeight":"96rpx","width":"calc(100% - 136rpx)","lineHeight":"48rpx","fontSize":"28rpx","float":"right"}'>{{ item.title }}</view>
		      <view :style='{"padding":"0 8rpx","color":"#999","textAlign":"left","width":"calc(100% - 136rpx)","lineHeight":"48rpx","fontSize":"26rpx","float":"right"}'>{{ item.addtime }}</view>
		    </view>
		  </view>
		</view>
