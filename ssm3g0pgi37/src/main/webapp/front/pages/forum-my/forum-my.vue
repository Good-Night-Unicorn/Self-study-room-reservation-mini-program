<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view class="list" :style='{"padding":"60rpx 20rpx"}'>
			<view v-for="(item,index) in list " v-bind:key="index" :style='{"border":"0px solid #ddd","padding":"30rpx","margin":"0 0 20rpx","borderRadius":"20rpx","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}'>
		...
		<!--list end-->
		<button :style='{"padding":"0 40rpx","margin":"40rpx 20rpx 40rpx 0","color":"#fff","borderRadius":"60rpx","textAlign":"center","background":"#174add","width":"auto","lineHeight":"80rpx","float":"right","height":"80rpx"}' @click="onUpdateTap()">新增</button>
	</mescroll-uni>
</template>
