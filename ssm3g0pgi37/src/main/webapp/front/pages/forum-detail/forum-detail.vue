<template>
	<view :style='{"alignContent":"flex-start","width":"100%","padding":"0","flexWrap":"wrap","background":"#fff","display":"flex"}'>
		...
		<view class="operateView" :style='{"padding":"24rpx 24rpx 0","margin":"0 auto 0","alignItems":"center","background":"#fff","display":"flex","width":"calc(100% - 0px)","fontSize":"30rpx","order":"0"}'>
			<view v-if="!likeType" :style='{"padding":"10rpx 50rpx","margin":"0 40rpx 0 0","color":"#666","borderRadius":"40rpx","textAlign":"center","background":"#d3e5ff","width":"auto"}' @click="likeClick">
			...
			<view v-if="!collectType" :style='{"width":"auto","padding":"10rpx 50rpx","color":"#666","borderRadius":"40rpx","textAlign":"center","background":"#d3e5ff"}' @click="collectClick">
